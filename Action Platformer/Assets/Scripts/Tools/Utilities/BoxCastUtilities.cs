...
namespace Denchik.Utilities
{
    public class BoxCastUtilities
    {
        ...
        {
            Debug.DrawLine(firstBox[0], secondBox[1], color);
            Debug.DrawLine(firstBox[1], secondBox[2], color);
            Debug.DrawLine(firstBox[2], secondBox[3], color);
            Debug.DrawLine(firstBox[3], secondBox[0], color);
        }
        ...
        private static Vector2 GetDistanceVector(float distance, Vector2 direction)
        {
            ...
            {
                float sceneWidth = Camera.main.orthographicSize * Camera.main.aspect * 2.0f;
                distance = sceneWidth * 5.0f;
            }
